...
if page == "Home":
    ...
    with col2:
        # Image on the right
        st.image("assets/mysore_palace1.jpg",  use_column_width=True)
...
# Attractions Page with 3 images in a row
    ...
    attractions = [
        {"name": "Chamundi Hills", "image": "assets/chamundi_hills.jpg"},
        {"name": "Brindavan Gardens", "image": "assets/brindavan_gardens.jpg"},
        {"name": "Mysore Zoo", "image": "assets/mysore_zoo.jpg"},
        {"name": "St. Philomena’s Church", "image": "assets/st_philomena.jpg"},
        {"name": "Karanji Lake", "image": "assets/karanji_lake.jpg"},
        {"name": "Rail Museum", "image": "assets/rail_museum.jpg"}
    ]
    ...
    for i in range(0, len(attractions), 3):
        ...
        for j in range(3):
            if i + j < len(attractions):
                with cols[j]:
                    st.image(attractions[i + j]["image"], caption=attractions[i + j]["name"], use_column_width=True)
